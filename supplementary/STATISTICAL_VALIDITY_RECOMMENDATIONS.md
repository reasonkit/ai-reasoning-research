...
_Note: Improvement is statistically significant (p < 0.0001, Cohen's h = 1.58,
large effect size). Confidence interval accounts for n=100 examples and sampling
variability. Task-specific result; gains vary significantly across benchmarks._
```
...
Cochrane Collaboration. (2024). _Cochrane Handbook for Systematic Reviews
of Interventions_, v6.4. https://training.cochrane.org/handbook

Higgins, J. P. T., & Green, S. (Eds.). (2011). _Cochrane handbook for
systematic reviews of interventions_ (Version 5.1.0). The Cochrane
Collaboration.

Liang, P. P., Bommasani, R., Lora, T., Steinhardt, J., Song, D., &
Abbeel, P. (2024). _Holistic evaluation of language models_. arXiv:2402.07929.
```
...
_End of recommendations document_
